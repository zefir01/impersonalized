{
    ...
    local _iamAttache = function(name, roleLabels=null, patches=[], policyLabels=null, policyArn=null, rolesMatchControllerRef=false){
        name: name,
        base: {
    ...
    local _role = function(name, labels, document=null, patches=[],){
        name: name,
        base: {
            apiVersion: "iam.aws.crossplane.io/v1beta1",
            kind: "Role",
    ...
    local _object = function(name, manifest, patches, managementPolicy="Default"){
        name: name,
        base: {
            apiVersion: "kubernetes.crossplane.io/v1alpha1",
            kind: "Object",
    ...
    local _policy = function(name, patches){
        name: name,
        base: {
            apiVersion: "iam.aws.crossplane.io/v1beta1",
            kind: "Policy",
        ...
        patches: patches +[
            _fromComposite("metadata.name", "spec.forProvider.name",
